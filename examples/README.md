...
| [`optional-path-params.ts`](./optional-path-params.ts)       | Optional path params, chained PathKit constraints, weighted number inference, UUIDs, and length constraints.                                    |
