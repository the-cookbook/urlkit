...
| [`pathless-url.ts`](./pathless-url.ts)                       | Pathless `url()` filters that ignore pathname matching while validating declared search params, repeated array params, enum values, suffix building, and unknown search behavior. |
